...
namespace Kubility
{
	...
	[CustomEditor(typeof(ImageExpand), true)]
	[CanEditMultipleObjects]
	public class ImageEditorExpand : ImageEditor
	{
		float showSize = 1f;
		float zoomScale = 1f;
		public override void OnInspectorGUI ()
		{
			...
			GUILayout.Space (5);
			EditorGUILayout.BeginVertical ();
			zoomScale =float.Parse( EditorGUILayout.TextField(new GUIContent("Scale :","Scale value for wid & height"), zoomScale.ToString()));
